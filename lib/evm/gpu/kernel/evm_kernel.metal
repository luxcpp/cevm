...
// Signed `rc` so refund subtraction can dip below zero per EIP-2200 ordering
// (e.g. orig!=0, cur==0 then write nv==0 cancels a prior credit). Cap to
// gas_used/5 happens at the dispatcher (EIP-3529) once execution finishes.
